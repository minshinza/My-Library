// describe('titleCade', function() {
//     it('should return The Quick Brown Fox Jumped Over The Lazy Dog whe given the quicl brown fox jumped over the lazy dog', function() {
//         var str = 'the quick brown fox jumped over tht lazy the lazy dog';
//         var result = titleCase(str);

//         expect(result).to.eql('The Quick Brown Fox Jumped Over The Lazy Dog');

//     });
//     it('should return A Christmas Carol when give a christmas carol', function() {
